...
audit_lane() {
  ...
  report_key "beskid/${lane}/platform-spec" "SESSION_SECRET"
  report_key "beskid/${lane}/platform-spec" "AUTH_HUB_PUBLIC_URL" "no"
  report_key "beskid/${lane}/platform-spec" "PLATFORM_SPEC_PUBLIC_URL" "no"
  report_key "beskid/${lane}/platform-spec" "MEMGRAPH_URI" "no"
  report_key "beskid/${lane}/platform-spec" "GITHUB_SYNC_TOKEN" "no"
  report_key "beskid/${lane}/platform-spec" "GITHUB_WEBHOOK_SECRET" "no"
  report_key "beskid/${lane}/platform-spec" "PLATFORM_SPEC_PAIRING_APPROVER_LOGIN" "no"
  report_key "beskid/${lane}/platform-spec" "PLATFORM_SPEC_MODERATOR_LOGINS" "no"
