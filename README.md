...
Vendored fork: [`vendor/terraform-provider-coolify/VENDOR.md`](vendor/terraform-provider-coolify/VENDOR.md). After provider changes: `./scripts/ci/lock-coolify-provider.sh`.
